...
#
# top_block.py was generated automatically by GNURadio.
# This file is a copy with a few changes to allow the script to decide
# where to save the file output.
#
...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self._gain_1_win = RangeWidget(
            self._gain_1_range, self.set_gain_1, 'gain_1', "counter_slider", float)
        self.top_grid_layout.addWidget(self._gain_1_win)
        self._gain_0_range = Range(0, 30, 1, 10, 200)
        self._gain_0_win = RangeWidget(
            self._gain_0_range, self.set_gain_0, 'gain_0', "counter_slider", float)
        ...
        if (total_args < 2):
            raise Exception(
                "Second parameter should be a new directory name, e.g. python read_data.py my_script_name")
